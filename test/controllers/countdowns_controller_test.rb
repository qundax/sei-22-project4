...
class CountdownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create countdown" do
    assert_difference('Countdown.count') do
      post countdowns_url, params: { countdown: { couple_id: @countdown.couple_id, date: @countdown.date, name: @countdown.name } }
    end
  ...
  test "should update countdown" do
    patch countdown_url(@countdown), params: { countdown: { couple_id: @countdown.couple_id, date: @countdown.date, name: @countdown.name } }
